...
import { Send, Bot, User, Loader2, RefreshCw, Download, FileText, Lightbulb, MessageSquare } from 'lucide-react';
    ...
    <div className="h-full flex flex-col">
      ...
      <CardContent className="flex-1 p-0">
        <Tabs defaultValue="chat" className="h-full">
          ...
          <TabsContent value="chat" className="h-[calc(100vh-300px)] m-0">
            <ScrollArea className="h-full scrollbar-mdmc">
              <div className="p-6 space-y-4">
                {messages.length === 0 ? (
                  <div className="text-center py-8">
                    <Bot className="h-12 w-12 text-[var(--mdmc-red)] mx-auto mb-4" />
                    <h3 className="text-lg font-semibold text-[var(--mdmc-black)] mb-2">
                      Assistant IA MDMC Prêt !
                    </h3>
                    <p className="text-[var(--mdmc-gray-600)] mb-4">
                      Posez votre première question ou explorez les exemples
                    </p>
                    <Button 
                      variant="outline" 
                      className="btn-mdmc-secondary"
          ...
          <TabsContent value="examples" className="h-[calc(100vh-300px)] m-0">
            <ScrollArea className="h-full scrollbar-mdmc">
              <div className="p-6">
                <ChatExamples onExampleClick={handleExampleClick} />
              </div>
            </ScrollArea>
          </TabsContent>
        </Tabs>
